...
`radian-gfx-sdf-flow` treats graphics as a local verification problem. The Dart implementation is intentionally narrow, but the fixtures and notes make the behavior explicit.

## Radian Gfx Sdf Flow Checkpoints
