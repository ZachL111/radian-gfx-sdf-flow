...
`radian-gfx-sdf-flow` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for sdf systems, covering simulation kernel, seeded input scenarios, and failure-oriented tests.
